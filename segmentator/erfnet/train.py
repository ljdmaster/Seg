...
#from data.camvid.data_processing import prepare_data, calculate_class_weights
...
if __name__ == '__main__':
    ...
    # TRAIN
    print("ALPHA --- 8e-4")
    model.train(data, n_epochs=80, print_every=5, batch_size=16, alpha=8e-4, dropout=0.3, l2=2e-4, aug_func=aug_func, viz_every=10)
    print("ALPHA --- 5e-4")
